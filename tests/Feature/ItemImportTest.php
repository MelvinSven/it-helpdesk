...
class ItemImportTest extends TestCase
{
    ...
    {
        return ['Kode Barang', 'Nama Barang', 'Merek', 'MAC Address', 'Tipe', 'Kondisi'];
    }
    ...
    public function test_duplicate_kode_barang_are_skipped(): void
    {
        $admin = User::factory()->create(['role' => User::ROLE_ADMIN]);
    ...
    public function test_nomor_seri_column_is_optional_and_imported_when_present(): void
    {
        $admin = User::factory()->create(['role' => User::ROLE_ADMIN]);
