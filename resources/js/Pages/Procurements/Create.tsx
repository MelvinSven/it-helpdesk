...
export default function Create() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('admin.procurements.store'), { forceFormData: true });
    };
    ...
    return (
        ...
        >
            <Head title="Pengajuan Barang Baru" />
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setData('form_file', e.target.files?.[0] ?? null)
                            }
                        ...
                        <p className="mt-1 text-xs text-gray-500">
                            Wajib diunggah. JPG, PNG, WEBP, atau PDF. Maksimal
                            5MB.
                        </p>
                        {progress && (
                            <p className="mt-1 text-xs text-gray-500">
